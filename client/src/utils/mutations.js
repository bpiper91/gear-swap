...
export const UPDATE_USER = gql`
    mutation UpdateUser($id: ID!, $firstName: String, $lastName: String, $email: String, $password: String, $location: String, $completedSwaps: Int) {
        updateUser(_id: $id, firstName: $firstName, lastName: $lastName, email: $email, password: $password, location: $location, completedSwaps: $completedSwaps) {
            _id
            firstName
            lastName
            email
...
export const CREATE_SWAP = gql`
    mutation CreateSwap($responder: String!, $groupId: ID!, $proposerListings: [String], $proposerCash: Int, $responderListings: [String], $responderCash: Int) {
        createSwap(responder: $responder, groupId: $groupId, proposerListings: $proposerListings, proposerCash: $proposerCash, responderListings: $responderListings, responderCash: $responderCash) {
            _id
            proposer
            proposerListings {
                _id
...
export const UPDATE_SWAP = gql`
    mutation UpdateSwap($id: ID!, $isActive: Boolean, $isCompleted: Boolean, $response: String) {
        updateSwap(_id: $id, isActive: $isActive, isCompleted: $isCompleted, response: $response) {
            _id
            proposer
            responder
            isActive
